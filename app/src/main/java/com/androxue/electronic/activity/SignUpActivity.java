...
import com.androxue.electronic.utils.VerifyCodeManager;
...
public class SignUpActivity extends Activity implements OnClickListener {
    ...
    private void initViews() {
        ...
        CleanEditText verifyCodeEdit = getView(R.id.et_verifiCode);
    ...
    public void Register(String account, String passWord, String niceName) throws IOException, JSONException {
        try {
            String httpUrl="http://192.168.2.110/cdz/user_register.php";
